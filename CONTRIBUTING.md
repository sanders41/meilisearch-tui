...
This creates the directory meilisearch-tui and connects your repository to the upstream (main project)
repository.
...
After pushing your code to origin it is now on GitHub but not yet part of the meilisearch-tui
